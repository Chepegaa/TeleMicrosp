...
function GoSubScribe(sBr) 
{
    ...
    document.getElementById("frmSubscribe").action = "/subscribe/subscribe.aspx";
    document.getElementById("frmSubscribe").method = "post";
...
function search_go() {
    ...
    location.href = AppPath + '/Search/SearchResult.aspx#brm-search?request_type=search&search_type=keyword&q=' + document.getElementById("ihKeyword").value + '&l=' + document.getElementById("ihKeyword").value;
